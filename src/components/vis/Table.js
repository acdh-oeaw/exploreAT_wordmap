...
Table.prototype.img="/public/table.svg";
Table.prototype.help="Table\n"+
    "Used to see data retrieved by the SPARQL query for the selected attributes.\n\n"+
    "Data used in the visualization:\n"+
    "Any arbitrary amount of attributes can be selected to be represented ascolumns.\n\n"+
    "Visual representation:\n"+
    "The table will show raw data for each entry, preseving the format but shorttening"+
    "the URIs (shown complete upon hover) and allowing to accessed linked data "+
    "by click interaction where available.\n\n"+
    "Configuration:\n";
